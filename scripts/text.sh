...
#-----------------------------------synthetic------------------------------------------
python lang.py "bangla" "bnmod" $save_dir $bn_fonts $backs_dir $bn_std --num_samples 100000
python lang.py "english" "enmod" $save_dir $en_fonts $backs_dir $en_std --num_samples 100000
#-----------------------------------synthetic------------------------------------------
echo succeded
