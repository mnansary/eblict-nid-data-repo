...
from locLib.locator import render_data
from locLib.utils import *
from locLib.config import aug,data_classes,marking
from locLib.augmentation import get_augmented_data
...
def main(args):
    ...
    for idx in tqdm(range(len(df))):
        ...
        face     =df.iloc[idx,2]
        mask_path=src.masks[f"{card_type}_{face}"]
        img,mask=render_data(backgen,img_path,mask_path,face,aug)
