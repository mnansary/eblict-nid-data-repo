...
from .augmentation import aug_template
...
class Data(object):
    def __init__(self,src_dir):
        ...
        masks["smart_front"]=os.path.join(self.res_dir,"smart_front_mask.png")
        masks["smart_back"] =os.path.join(self.res_dir,"smart_back_mask.png")
        masks["nid_front"]  =os.path.join(self.res_dir,"nid_front_mask.png")
        masks["nid_back"]   =os.path.join(self.res_dir,"nid_back_mask.png")
